...
urlpatterns = patterns('',
   ...
   (r'^reset/$', 'front.views.password_reset', {'template_name': 'front/password_reset_form.html', 'email_template_name':'front/password_reset_email.html'}),
   (r'^reset/done/$', 'django.contrib.auth.views.password_reset_done', {'template_name': 'front/password_reset_done.html'}),
   (r'^reset/(?P<uidb36>[0-9A-Za-z]+)-(?P<token>.+)/$', 'django.contrib.auth.views.password_reset_confirm', {'template_name': 'front/password_reset_confirm.html'}),
   (r'^reset/complete/$', 'django.contrib.auth.views.password_reset_complete', {'template_name': 'front/password_reset_complete.html'}),
