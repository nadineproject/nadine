...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.valid_billing'
        db.add_column('staff_member', 'valid_billing',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.valid_billing'
        db.delete_column('staff_member', 'valid_billing')
    ...
    models = {
        ...
        'staff.dailylog': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 10, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
