...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('staff_member', 'address1', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)
        db.add_column('staff_member', 'address2', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)
        db.add_column('staff_member', 'city', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)
        db.add_column('staff_member', 'state', self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True), keep_default=False)
        db.add_column('staff_member', 'zipcode', self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True), keep_default=False)

        # Adding url field 
        db.rename_column('staff_member', 'website', 'url_personal')
        db.add_column('staff_member', 'url_professional', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)
        db.add_column('staff_member', 'url_facebook', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)
        db.add_column('staff_member', 'url_twitter', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)
        db.add_column('staff_member', 'url_linkedin', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)
        db.add_column('staff_member', 'url_loosecubes', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)
        db.add_column('staff_member', 'url_biznik', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('staff_member', 'address1')
        db.delete_column('staff_member', 'address2')
        db.delete_column('staff_member', 'city')
        db.delete_column('staff_member', 'state')
        db.delete_column('staff_member', 'zipcode')

        db.rename_column('staff_member', 'url_personal', 'website')
        db.delete_column('staff_member', 'url_professional')
        db.delete_column('staff_member', 'url_facebook')
        db.delete_column('staff_member', 'url_twitter')
        db.delete_column('staff_member', 'url_linkedin')
        db.delete_column('staff_member', 'url_loosecubes')
        db.delete_column('staff_member', 'url_biznik')
    ...
    models = {
        ...
        'staff.dailylog': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 13, 18, 21, 52, 230943)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'staff.member': {
            ...
            'url_loosecubes': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
