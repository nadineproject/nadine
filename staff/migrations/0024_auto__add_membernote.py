...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MemberNote'
        db.create_table(u'staff_membernote', (
        ...
        db.send_create_signal(u'staff', ['MemberNote'])


    def backwards(self, orm):
        # Deleting model 'MemberNote'
        db.delete_table(u'staff_membernote')
