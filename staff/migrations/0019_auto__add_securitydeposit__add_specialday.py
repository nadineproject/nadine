...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SecurityDeposit'
        db.create_table(u'staff_securitydeposit', (
            ...
            ('returned_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'staff', ['SecurityDeposit'])

        # Adding model 'SpecialDay'
        db.create_table(u'staff_specialday', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.Member'])),
            ('year', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('month', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('day', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
        ))
        db.send_create_signal(u'staff', ['SpecialDay'])


    def backwards(self, orm):
        # Deleting model 'SecurityDeposit'
        db.delete_table(u'staff_securitydeposit')

        # Deleting model 'SpecialDay'
        db.delete_table(u'staff_specialday')
    ...
    models = {
        ...
        u'staff.dailylog': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 4, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
