...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Membership.plan'
        db.delete_column('staff_membership', 'plan')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Membership.plan'
        raise RuntimeError("Cannot reverse this migration. 'Membership.plan' and its values cannot be restored.")
    ...
    models = {
        ...
        'staff.dailylog': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 1, 16, 8, 50, 544790)', 'auto_now_add': 'True', 'blank': 'True'}),
