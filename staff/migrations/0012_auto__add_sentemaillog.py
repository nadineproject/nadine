...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SentEmailLog'
        db.create_table('staff_sentemaillog', (
        ...
        db.send_create_signal('staff', ['SentEmailLog'])


    def backwards(self, orm):
        # Deleting model 'SentEmailLog'
        db.delete_table('staff_sentemaillog')
    ...
    models = {
        ...
        'staff.dailylog': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 18, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
