...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SentEmailLog.member'
        db.add_column(u'staff_sentemaillog', 'member',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.Member'], null=True),
                      keep_default=False)


        # Changing field 'Member.phone2'
        db.alter_column(u'staff_member', 'phone2', self.gf('django_localflavor_us.models.PhoneNumberField')(max_length=20, null=True))

        # Changing field 'Member.phone'
        db.alter_column(u'staff_member', 'phone', self.gf('django_localflavor_us.models.PhoneNumberField')(max_length=20, null=True))

        # Changing field 'Member.gender'
        db.alter_column(u'staff_member', 'gender', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):
        # Deleting field 'SentEmailLog.member'
        db.delete_column(u'staff_sentemaillog', 'member_id')


        # Changing field 'Member.phone2'
        db.alter_column(u'staff_member', 'phone2', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True))

        # Changing field 'Member.phone'
        db.alter_column(u'staff_member', 'phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True))

        # Changing field 'Member.gender'
        db.alter_column(u'staff_member', 'gender', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
    ...
    models = {
        ...
        u'staff.dailylog': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 11, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
