...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Membership.deposit_amount'
        db.delete_column(u'staff_membership', 'deposit_amount')

        # Deleting field 'MembershipPlan.deposit_amount'
        db.delete_column(u'staff_membershipplan', 'deposit_amount')
