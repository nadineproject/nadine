...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bill.new_member_deposit'
        db.alter_column('staff_bill', 'new_member_deposit', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'BillingLog.successful'
        db.alter_column('staff_billinglog', 'successful', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Onboard_Task.monthly_only'
        db.alter_column('staff_onboard_task', 'monthly_only', self.gf('django.db.models.fields.BooleanField')(blank=True))


    def backwards(self, orm):
        
        # Changing field 'Bill.new_member_deposit'
        db.alter_column('staff_bill', 'new_member_deposit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'BillingLog.successful'
        db.alter_column('staff_billinglog', 'successful', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Onboard_Task.monthly_only'
        db.alter_column('staff_onboard_task', 'monthly_only', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'staff.dailylog': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 29, 16, 31, 28, 519421)', 'auto_now_add': 'True', 'blank': 'True'}),
