...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for m in orm.Membership.objects.filter(deposit_amount__gt=0):
           deposit = orm.SecurityDeposit.objects.create(member=m.member, received_date=m.start_date, amount=m.deposit_amount)
