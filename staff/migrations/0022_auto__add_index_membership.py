...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Membership', fields ['end_date']
        db.create_index(u'staff_membership', ['end_date'])

        # Adding index on 'Membership', fields ['start_date']
        db.create_index(u'staff_membership', ['start_date'])


    def backwards(self, orm):
        # Removing index on 'Membership', fields ['start_date']
        db.delete_index(u'staff_membership', ['start_date'])

        # Removing index on 'Membership', fields ['end_date']
        db.delete_index(u'staff_membership', ['end_date'])
    ...
    models = {
        ...
        u'staff.dailylog': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 24, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
