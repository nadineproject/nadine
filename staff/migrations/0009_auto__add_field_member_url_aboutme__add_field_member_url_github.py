...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Member.url_aboutme'
        db.add_column('staff_member', 'url_aboutme', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Member.url_github'
        db.add_column('staff_member', 'url_github', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Member.url_aboutme'
        db.delete_column('staff_member', 'url_aboutme')

        # Deleting field 'Member.url_github'
        db.delete_column('staff_member', 'url_github')
    ...
    models = {
        ...
        'staff.dailylog': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 29, 10, 4, 4, 476040)', 'auto_now_add': 'True', 'blank': 'True'}),
