...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membership.has_key'
        db.add_column(u'staff_membership', 'has_key',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Membership.has_mail'
        db.add_column(u'staff_membership', 'has_mail',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membership.has_key'
        db.delete_column(u'staff_membership', 'has_key')

        # Deleting field 'Membership.has_mail'
        db.delete_column(u'staff_membership', 'has_mail')
    ...
    models = {
        ...
        u'staff.membership': {
            ...
            'has_key': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'has_mail': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
