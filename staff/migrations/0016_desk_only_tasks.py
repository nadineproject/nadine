...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Onboard_Task.monthly_only'
        db.delete_column(u'staff_onboard_task', 'monthly_only')

        # Adding field 'Onboard_Task.has_desk_only'
        db.add_column(u'staff_onboard_task', 'has_desk_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ExitTask.has_desk_only'
        db.add_column(u'staff_exittask', 'has_desk_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Onboard_Task.monthly_only'
        db.add_column(u'staff_onboard_task', 'monthly_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Onboard_Task.has_desk_only'
        db.delete_column(u'staff_onboard_task', 'has_desk_only')

        # Deleting field 'ExitTask.has_desk_only'
        db.delete_column(u'staff_exittask', 'has_desk_only')
    ...
    models = {
        ...
        u'staff.dailylog': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 30, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
