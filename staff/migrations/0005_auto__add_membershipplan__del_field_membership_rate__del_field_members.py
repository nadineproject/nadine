...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MembershipPlan'
        db.create_table('staff_membershipplan', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('monthly_rate', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('daily_rate', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('dropin_allowance', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('deposit_amount', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('has_desk', self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True)),
        ))
        db.send_create_signal('staff', ['MembershipPlan'])

        # Rename field 'Membership.rate'
        db.rename_column('staff_membership', 'rate', 'monthly_rate')

        # Rename field 'Membership.guest_dropins'
        db.rename_column('staff_membership', 'guest_dropins', 'dropin_allowance')

        # Adding field 'Membership.membership_plan'
        db.add_column('staff_membership', 'membership_plan', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.MembershipPlan'], null=True), keep_default=False)

        # Adding field 'Membership.daily_rate'
        db.add_column('staff_membership', 'daily_rate', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Membership.deposit_amount'
        db.add_column('staff_membership', 'deposit_amount', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Membership.has_desk'
        db.add_column('staff_membership', 'has_desk', self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Rename fields 'Membership.rate' and 'guest_dropins'
        db.rename_column('staff_membership', 'monthly_rate', 'rate')
        db.rename_column('staff_membership', 'dropin_allowance', 'guest_dropins')
        
        # Deleting new fields
        db.delete_column('staff_membership', 'membership_plan_id')
        db.delete_column('staff_membership', 'monthly_rate')
        db.delete_column('staff_membership', 'dropin_allowance')
        db.delete_column('staff_membership', 'daily_rate')
        db.delete_column('staff_membership', 'deposit_amount')
        db.delete_column('staff_membership', 'has_desk')

        # Deleting model 'MembershipPlan'
        db.delete_table('staff_membershipplan')
    ...
    models = {
        ...
        'staff.dailylog': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 1, 15, 22, 51, 607916)', 'auto_now_add': 'True', 'blank': 'True'}),
