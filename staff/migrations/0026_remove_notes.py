...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Membership.note'
        db.delete_column(u'staff_membership', 'note')

        # Deleting field 'Member.notes'
        db.delete_column(u'staff_member', 'notes')


    def backwards(self, orm):
        # Adding field 'Membership.note'
        db.add_column(u'staff_membership', 'note',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Member.notes'
        db.add_column(u'staff_member', 'notes',
    ...
    models = {
        ...
        u'staff.dailylog': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 24, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
