...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Membership.has_desk'
        db.alter_column(u'staff_membership', 'has_desk', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Membership.has_mail'
        db.alter_column(u'staff_membership', 'has_mail', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Membership.has_key'
        db.alter_column(u'staff_membership', 'has_key', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'Membership.has_desk'
        db.alter_column(u'staff_membership', 'has_desk', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Membership.has_mail'
        db.alter_column(u'staff_membership', 'has_mail', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Membership.has_key'
        db.alter_column(u'staff_membership', 'has_key', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    models = {
        ...
        u'staff.dailylog': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 20, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'staff.exittask': {
            ...
            'has_desk_only': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
