...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OutgoingMail.sent_recipients'
        db.add_column('interlink_outgoingmail', 'sent_recipients',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'MailingList.throttle_limit'
        db.add_column('interlink_mailinglist', 'throttle_limit',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'OutgoingMail.sent_recipients'
        db.delete_column('interlink_outgoingmail', 'sent_recipients')

        # Deleting field 'MailingList.throttle_limit'
        db.delete_column('interlink_mailinglist', 'throttle_limit')
    ...
    models = {
        ...
        'interlink.incomingmail': {
            ...
            'original_message': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        'interlink.mailinglist': {
            ...
            'throttle_limit': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        'interlink.outgoingmail': {
            ...
            'original_mail': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['interlink.IncomingMail']", 'null': 'True', 'blank': 'True'}),
            'sent': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'sent_recipients': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'subject': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        }
    }
