...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IncomingMail.original_message'
        db.add_column('interlink_incomingmail', 'original_message', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'IncomingMail.original_message'
        db.delete_column('interlink_incomingmail', 'original_message')
