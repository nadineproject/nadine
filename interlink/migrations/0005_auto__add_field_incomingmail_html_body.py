...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IncomingMail.html_body'
        db.add_column('interlink_incomingmail', 'html_body', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'IncomingMail.html_body'
        db.delete_column('interlink_incomingmail', 'html_body')
