...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OutgoingMail.body'
        db.alter_column('interlink_outgoingmail', 'body', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'OutgoingMail.html_body'
        db.alter_column('interlink_outgoingmail', 'html_body', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'OutgoingMail.body'
        db.alter_column('interlink_outgoingmail', 'body', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'OutgoingMail.html_body'
        db.alter_column('interlink_outgoingmail', 'html_body', self.gf('django.db.models.fields.TextField')(default=''))
