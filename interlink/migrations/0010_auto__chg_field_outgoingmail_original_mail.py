...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OutgoingMail.original_mail'
        db.alter_column('interlink_outgoingmail', 'original_mail_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interlink.IncomingMail'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'OutgoingMail.original_mail'
        raise RuntimeError("Cannot reverse this migration. 'OutgoingMail.original_mail' and its values cannot be restored.")
