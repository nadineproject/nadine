...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IncomingMail.sent_time'
        db.add_column('interlink_incomingmail', 'sent_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 29, 9, 29, 16, 647578)), keep_default=False)

        # Adding field 'IncomingMail.state'
        db.add_column('interlink_incomingmail', 'state', self.gf('django.db.models.fields.CharField')(default='raw', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'IncomingMail.sent_time'
        db.delete_column('interlink_incomingmail', 'sent_time')

        # Deleting field 'IncomingMail.state'
        db.delete_column('interlink_incomingmail', 'state')
