...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IncomingMail.body'
        db.alter_column('interlink_incomingmail', 'body', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'IncomingMail.html_body'
        db.alter_column('interlink_incomingmail', 'html_body', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'IncomingMail.body'
        db.alter_column('interlink_incomingmail', 'body', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'IncomingMail.html_body'
        db.alter_column('interlink_incomingmail', 'html_body', self.gf('django.db.models.fields.TextField')(default=''))
