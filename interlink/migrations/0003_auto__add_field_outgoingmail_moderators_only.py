...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OutgoingMail.moderators_only'
        db.add_column('interlink_outgoingmail', 'moderators_only', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OutgoingMail.moderators_only'
        db.delete_column('interlink_outgoingmail', 'moderators_only')
