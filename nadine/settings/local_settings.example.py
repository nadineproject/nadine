...
NEXTCLOUD_USER_DEFAULT_PASSWORD = None
NEXTCLOUD_USER_SEND_EMAIL_PASSWORD = False
...
ROCKETCHAT_USER_DEFAULT_PASSWORD = None
...
# Elocky Settings
ELOCKY_API_CLIENT_ID = 'api_client_id'
ELOCKY_API_CLIENT_SECRET = 'api_client_secret'
ELOCKY_USERNAME = 'admin'
ELOCKY_PASSWORD = 'password'
CRYPTOGRAPHY_KEY = 'YOUR-SECRET-KEY'
