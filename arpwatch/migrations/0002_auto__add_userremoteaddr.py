...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserRemoteAddr'
        db.create_table('arpwatch_userremoteaddr', (
        ...
        db.send_create_signal('arpwatch', ['UserRemoteAddr'])


    def backwards(self, orm):
        
        # Deleting model 'UserRemoteAddr'
        db.delete_table('arpwatch_userremoteaddr')
    ...
    models = {
        ...
        'arpwatch.userremoteaddr': {
            'Meta': {'object_name': 'UserRemoteAddr'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_address': ('django.db.models.fields.IPAddressField', [], {'max_length': '15'}),
