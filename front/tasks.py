...
class EmailTask(Task):
   """A recurring task which checks the pending email records and sends email as necessary."""
   def __init__(self, loopdelay=10, initdelay=1):
   ...
   def perform_task(self):
      ...
      try:
         for entry in EmailEntry.objects.unsent_entries():
            entry.attempt_to_send()
      except:
         traceback.print_exc()
